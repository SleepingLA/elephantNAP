...
if false; then
 ...
 wget http://apache.mirror.vexxhost.com/spark/spark-2.2.1/spark-2.2.1-bin-hadoop2.7.tgz
 ...
 wget https://repo1.maven.org/maven2/com/facebook/presto/presto-cli/0.194/presto-cli-0.194-executable.jar
...
mv spark-2.2.1-bin-hadoop2.7.tgz ${NAPDIR}/ansible/roles/hadoop/files
...
mv presto-server-0.194.tar.gz ${NAPDIR}/ansible/roles/presto/files
mv presto-cli-0.194-executable.jar ${NAPDIR}/ansible/roles/presto/files
