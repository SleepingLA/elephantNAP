...
if false; then
 ...
 wget http://apache.mirror.vexxhost.com/spark/spark-2.3.1/spark-2.3.0-bin-hadoop2.7.tgz
 ...
 wget --no-check-certificate https://repo1.maven.org/maven2/com/facebook/presto/presto-server/0.204/presto-server-0.204.tar.gz
 wget --no-check-certificate  https://repo1.maven.org/maven2/com/facebook/presto/presto-cli/0.204/presto-cli-0.204-executable.jar
...
mv spark-2.3.1-bin-hadoop2.7.tgz ${NAPDIR}/ansible/roles/hadoop/files
...
mv presto-server-0.204.tar.gz ${NAPDIR}/ansible/roles/presto/files
mv presto-cli-0.204-executable.jar ${NAPDIR}/ansible/roles/presto/files
